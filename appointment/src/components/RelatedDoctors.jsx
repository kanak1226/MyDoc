  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 dark:text-white md:mx-10'>
      ...
      <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
        {relDoc.slice(0, 5).map((item, index) => (
          <div
            ...
            className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500 dark:border-blue-700'
            key={index}
          >
      ...
      <button
        ...
        className='bg-gradient-to-r from-gray-400 to-black text-white px-12 py-3 rounded-full mt-10 hover:scale-105 hover:shadow-xl transition-all duration-300'
      >
        More
      </button>
    </div>
